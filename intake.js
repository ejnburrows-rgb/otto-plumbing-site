...
(function () {
  ...
  var COPY = {
    en: {
      ...
      formLead: 'Send the job details and the office will follow up. Nothing is reported as sent unless the receiving system confirms it.',
      submitIdle: 'Send request',
      submitSending: 'Sending, please wait',
      submitEmail: 'Prepare email request',
      callInstead: 'Call now',
      ...
      fallbackCall: 'Call now',
      fallbackText: 'Text now',
    ...
    es: {
      ...
      formLead: 'Envie los detalles del trabajo y la oficina le respondera. Nada se reporta como enviado hasta que el sistema receptor lo confirme.',
