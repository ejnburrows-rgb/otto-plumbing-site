...
/* Markers chosen because each is a single unambiguous fact about the source,
   and each changes only when the source changes. Counting occurrences rather
   than matching whole pages keeps this stable against whitespace. */
const MARKERS = [
  {
