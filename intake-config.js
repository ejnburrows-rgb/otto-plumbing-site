...
/* Publish no testimonial until the owner supplies a source that can be checked. */
...
(function () {
  ...
  /* Load the final conversion layer as early as this bootstrap can, before the
   * customer-facing enhancement scripts settle the DOM. */
  stylesheet('conversion-polish.css');
